...
public class CodeGenerator {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/oldman?serverTimezone=GMT%2B8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "125800";
    private static final String PROJECT = "oldman";
